...
HTML是使用正确的HTML标签来描述内容的含义，而不仅仅是页面。
提高代码的开发性；有利于无障碍读取性，让屏幕阅读器更好的解析；提高SEO，让搜索引擎更好的解释；有利于开发者协作开发
...
答案：console.log(introduce.call(student1,6年级,希望小学));
console.log(introducae.apply(student1，[6年级,希望小学]));
console.log(bindFunc(student1))
...
答案：1.John;Hello, I'm undefind
2.Hello, I'm undefind
3.Hello, I'm John
